...
app.dpi.module('feed', [
    function () {
        ...
        //    feedUrl = 'http://chromeye.com/betfair/feeds/Chaltenham2016Feed-route2 -demo.v3Mpu.json?',
            feedUrl = 'http://chromeye.com/betfair/feeds/Chaltenham2016Feed-route2-demo.v4.json?',
    ...
    function (feed, terms) {
        ...
        IntroHorse.prototype.init = function (data, checkLoop) {
            ...
            function particle() {
                ...
                this.speed = {x: -20 + Math.random() * 15, y: -30 + Math.random() * 6};
                //location = mouse coordinates
                this.location = {x: W / 2.5, y: H / 1.1};
                //radius range = 10-30
                this.radius = 7 + Math.random() * 1;
                //life range = 20-30
            ...
            function draw() {
                ...
                ctxFront.fillStyle = "rgba(0, 0, 0,0)";
                ctxFront.background = "transparent";
                ctxFront.fillRect(0, 0, W, H);
                ctxFront.globalCompositeOperation = "color";
                ...
                for (var i = 0; i < particles.length; i++) {
                    ...
                    var gradient2 = ctxFront.createRadialGradient(p.location.x, p.location.y, 0, p.location.x, p.location.y, p.radius);
                    ...
                    gradient2.addColorStop(0, "rgba(" + p.r + ", " + p.g + ", " + p.b + ", " + p.opacity + ")");
                    gradient2.addColorStop(0.5, "rgba(" + p.r + ", " + p.g + ", " + p.b + ", " + p.opacity + ")");
                    gradient2.addColorStop(1, "rgba(" + p.r + ", " + p.g + ", " + p.b + ", 0)");
                    ctxFront.fillStyle = gradient;
                    ctxFront.arc(p.location.x, p.location.y, p.radius, Math.PI * 2, false);
                    ctxFront.fill();
            ...
            var darwInterval;
            var getMuddy = function () {
                //draw();
                darwInterval = setInterval(draw, 40);
                //darwInterval;
                setInterval(clearCanvas, 750);
            ...
            var stopMud = function stopMud() {
                clearInterval(darwInterval);
            }
            ...
            this.tween
                ...
                .to('#canvas', 1.5, {x: '+=5px', y: '-20px', ease: Sine.easeOut}, '-=2')
                .to(self.rail, 0.45, {bottom: 56, ease: Sine.easeOut}, '-=2.8')
                .to(self.rail, 2.5, {
                    x: '-=190px', scale: 1.2,
                    z: 0.1, /* add this for the jitter bug */
                    rotationZ: "0.01deg", /* add this for the jitter bug */
                ...
                .to([self.leftDirt, self.asset], 0.3, {autoAlpha: 0, ease: Sine.easeOut, onStart: stopMud}, '-=0.4')
        ...
        FinalScr.prototype.init = function (checkLoop) {
            ...
            if (self.hasDay1) {
                ...
                function updateHandler() {
                    if (self.hasDay1) {
                        self.textMid.textContent = bets.score.toFixed(0);
    ...
    function (feed, terms) {
        ...
        FinalScrOffer2.prototype.init = function (checkLoop) {
            ...
            this.tween
                ...
                .from(this.textBot, 0.5, {top: 200, autoAlpha: 0, ease: Elastic.easeOut.config(0.3, 0.2)}, '-=0.1')
        ...
        FinalScrOffer3.prototype.init = function (checkLoop) {
            ...
            this.tween
                ...
                .from(this.textBot, 0.5, {
                    autoAlpha: 0, top: 200, ease: Elastic.easeOut.config(0.2, 0.2),
