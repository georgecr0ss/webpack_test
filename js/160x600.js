...
app.dpi.module('fonts', ['feed', 'documentLoad', function (feed) {
    ...
    app.dpi.loadScript('https://ajax.googleapis.com/ajax/libs/webfont/1.6.16/webfont.js', true);
}]);
app.dpi.module('feed', [
    function () {
    ...
    function (feed, terms) {
        ...
        IntroHorse.prototype.init = function (data, checkLoop) {
            ...
            this.tween
                ...
                .to(self.longContainer, 0.5, {clip: "rect(0px, 160px, 55px, 0px)", ease: Power0.easeNone}, '-=0.4')
                ...
                .from('#cta', 0.5, {bottom: -28, ease: Sine.easeOut}, '-=0')

                .to(self.topLine, 0.4, {clip: "rect(0px, 160px, 1px, 0px)", ease: Sine.easeOut}, '-=0.7')
                .to(self.botLine, 0.4, {clip: "rect(0px, 160px, 1px, 0px)", ease: Sine.easeOut}, '-=0.7')
                ...
                .to('#header', 0.2, {clip: "rect(0px, 160px, 55px, 0px)", ease: Power0.easeNone}, '-=0.25')
                ...
                .to(self.rail, 0.4, {bottom: 65, ease: Sine.easeOut}, '-=3.4')
                .to(self.rail, 2.9, {
                    x: '-=80px', scale: 1,
                    z: 0.1, /* add this for the jitter bug */
                    rotationZ: "0.01deg", /* add this for the jitter bug */
                ...
                .to(self.rail, 0.2, {autoAlpha: 0, ease: Sine.easeOut}, '-=0.6')
                .to([self.leftDirt, self.asset], 0.3, {autoAlpha: 0, ease: Sine.easeOut}, '-=0.35')
            ...
            if (this.hasText) {
                this.tween
                    .to(this.topText, 0.35, {clip: " rect(0px, 160px, 70px, 0px)", ease: Sine.easeOut}, '-=3.5')
                    .to(this.botText, 0.35, {clip: " rect(0px, 160px, 90px, 0px)", ease: Sine.easeOut}, '-=3.5')
            }
            ...
            if (this.hasText) {
                this.tween
                    ...
                    .to(this.botText, 0.3, {clip: " rect(0px, 160px, 90px, 160px)", ease: Sine.easeOut}, '-=0.3')
            }

            if (this.isFinalScreen) {
                this.tween
                    .to('#header', 0.5, {clip: "rect(25px 80px 25px 80px)", ease: Sine.easeOut}, '-=.25')
                    .to('#introLogo', 0.5, {top: -60, ease: Sine.easeOut}, '-=.5')
                    .to('#cta', 0.5, {bottom: -28, ease: Sine.easeOut}, '-=.5')
