...
var app = {
    ...
    // https://static.streameye.net/fonts/v2/bf_fonts_flama_book.css
    bannerSize: '300x250',
...
app.dpi.module('IntroHorse', ['feed', 'terms', 'documentLoad', 'fonts',
    function (feed, terms) {
        ...
        IntroHorse.prototype.init = function (data, checkLoop) {
            ...
            shakeTween.
                fromTo([self.leftDirt, self.rightDirt, self.asset], 0.8, {
                    y: '-=0.7'
                }, {
                    y: '+=0.7',
            ...
            this.tween
                .set([self.leftDirt, self.asset, self.rail], {
                    autoAlpha: 1
                })
                .set('#introLogo', {
                ...
                .to([self.leftDirt, self.asset, self.rail], 0.3, {
                    autoAlpha: 0,
                    ease: Sine.easeOut
                }, '-=0.1')
            ...
            if (this.hasText) {
                this.tween
                    .to(this.topText, 0.35, {
                        clip: " rect(0px, 200px, 50px, 0px)",
                        ease: Sine.easeOut
                    }, '-=0')
                    .to(this.botText, 0.35, {
                        clip: " rect(0px, 200px, 50px, 0px)",
                        ease: Sine.easeOut
                    }, '-=0.35')
            }
            ...
            if (this.hasText) {
                this.tween
                    ...
                    .to(this.botText, 0.3, {
                        clip: " rect(0px, 200px, 50px, 200px)",
                        ease: Sine.easeOut
                    }, '-=0.3')
            }
            ...
            if (loops > feed.looping) {
                if (screens[screenIndex].hasText) {
                    ...
                    TweenLite.delayedCall(2.7, function () {
                        screens[screenIndex].tween.restart();
                        screens[screenIndex].tween.play(screens[screenIndex].tween.totalDuration() - 3.5);
                    ...
                    TweenLite.delayedCall(2.7, function () {
                        screens[screenIndex].tween.restart();
                        screens[screenIndex].tween.play(screens[screenIndex].tween.totalDuration() - 0.9);
                        //console.log(screens[screenIndex].tween.totalDuration() - 0.25);
                    });
                }
