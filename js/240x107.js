...
var app = {
    ...
    // fontsPath: 'http://static.streameye.net/fonts/v2/',
...
            
        ...
        IntroHorse.prototype.init = function (data, checkLoop) {
            ...
            this.tween
                ...
                .set([self.leftDirt, self.asset, self.rail, '#header'], {autoAlpha: 1})
                ...
                .to(self.topLine, 0.4, {clip: "rect(0px, 234px, 1px, 0px)", ease: Sine.easeOut}, '-=0')
                // .to(self.topLine, 0.4, {clip: "rect(0px, 234px, 1px, 25px)", ease: Sine.easeOut}, '-=0.3')
                .to(self.botLine, 0.4, {clip: "rect(0px, 234px, 1px, 0px)", ease: Sine.easeOut}, '-=.5')
                ...
                .to('#header', 0.3, {top: 0, ease: Sine.easeOut}, '-=0.3')
                //HORSE
            ...
            if (this.hasText) {
                this.tween
                    .to(this.topText, 0.4, {clip: " rect(0px, 165px, 24px, 0px)", ease: Sine.easeOut}, '-=3')
                    .to(this.botText, 0.4, {clip: " rect(0px, 165px, 24px, 0px)", ease: Sine.easeOut}, '-=3')
            }
            ...
            if (this.hasText) {
                this.tween
                    .to(this.topText, 0.3, {clip: " rect(0px, 165px, 24px, 165px)", ease: Sine.easeIn}, '-=0.2')
                    .to(this.botText, 0.3, {clip: " rect(0px, 0px, 24px, 0px)", ease: Sine.easeIn}, '-=0.3')
            }
            if (this.isFinalScreen) {
                this.tween
                    .to('#header', 0.5, {top: -12, ease: Sine.easeOut}, '-=0')
                    .to('#footer', 0.5, {
    ...
    function (feed, terms) {
        ...
        function FinalScr(data, onComplete, isFinalScreen, checkLoop) {
            ...
            if (navigator.userAgent.indexOf('Mac OS X') != -1) {
                ...
                if (this.hasDay1) {
                    this.textMid.style.padding = '0px 2px 1px';
                }
            }
    ...
    function (feed, terms) {
        ...
        FinalScrOffer2.prototype.init = function (checkLoop) {
            ...
            this.tween
                ...
                .from(this.textBot, 0.5, {top: 107, ease: Elastic.easeOut.config(0.3, 0.2)}, '-=0.1')
        ...
        function playFirstScreen() {
            ...
            if (loops > feed.looping) {
                if (screens[screenIndex].hasText) {
                    screens[screenIndex].tween.restart();
                    screens[screenIndex].tween.play(2.1);
                    // TweenLite.delayedCall(4, showCta);

                    TweenLite.delayedCall(3.1, function () {
                        screens[screenIndex].tween.restart();
                        screens[screenIndex].tween.play(screens[screenIndex].tween.totalDuration() - 0);
                    });
                } else {
                    screens[screenIndex].tween.restart();
                    screens[screenIndex].tween.play(2.1);
