...
app.dpi.module('IntroHorse', ['feed', 'terms', 'documentLoad', 'fonts',
    function (feed, terms) {
        ...
        function IntroHorse(data, onComplete, isFinalScreen, checkLoop) {
            ...
            this.asset.id = 'horse';
            var assetUrl = app.assetPath + assetName;
    ...
    function (feed, terms) {
        ...
        function FinalScr(data, onComplete, isFinalScreen, checkLoop) {
            ...
            if (this.hasDay1) {
                ...
                this.textMid.innerText = app.parseText('1', data.altColor);
                ...
                if (navigator.userAgent.indexOf('Mac OS X') != -1) {
                    ...
                    this.textMid.style.paddingBottom = '8px';
                }
        ...
        FinalScrOffer3.prototype.init = function (checkLoop) {
            ...
            this.tween
                ...
                .from(this.textBot, 0.5, {
                    autoAlpha: 0, top: 160, ease: Elastic.easeOut.config(0.2, 0.2),
