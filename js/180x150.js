    ...
    function (feed, terms) {
        ...
        IntroHorse.prototype.init = function (data, checkLoop) {
            ...
            this.tween
                ...
                .to(self.topLine, 0.4, {clip: "rect(0px, 180px, 1px, 0px)", ease: Sine.easeOut}, '-=0')
                .to(self.botLine, 0.4, {clip: "rect(0px, 180px, 1px, 0px)", ease: Sine.easeOut}, '-=.5')

                .to(self.topLine, 0.25, {clip: "rect(0px, 180px, 1px, 180px)", ease: Sine.easeIn}, '+=1')
            ...
            if (this.hasText) {
                this.tween
                    .to(this.topText, 0.35, {clip: " rect(0px, 180px, 35px, 0px)", ease: Sine.easeOut}, '-=0')
                    .to(this.botText, 0.35, {clip: " rect(0px, 180px, 35px, 0px)", ease: Sine.easeOut}, '-=0.35')
            }
            ...
            if (this.hasText) {
                this.tween
                    .to(this.topText, 0.3, {clip: " rect(0px, 0px, 35px, 0px)", ease: Sine.easeOut}, '+=2')
                    .to(this.botText, 0.3, {clip: " rect(0px, 180px, 35px, 180px)", ease: Sine.easeOut}, '-=0.3')
            }
            ...
            if (loops > feed.looping) {
                if (screens[screenIndex].hasText) {
                    ...
                    TweenLite.delayedCall(2.6, function () {
                        screens[screenIndex].tween.restart();
                        screens[screenIndex].tween.play(screens[screenIndex].tween.totalDuration() - 3.6);
                    });
                } else {
                    screens[screenIndex].tween.restart();
                    screens[screenIndex].tween.play(2.5);
                    TweenLite.delayedCall(3.4, showCta);

                    TweenLite.delayedCall(2.4, function () {
                        screens[screenIndex].tween.restart();
                        screens[screenIndex].tween.play(screens[screenIndex].tween.totalDuration() - 0.65);
