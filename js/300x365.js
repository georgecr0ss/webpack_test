    ...
    function (feed, terms) {
        ...
        function IntroHorse(data, onComplete, isFinalScreen, checkLoop) {
            ...
            if (navigator.userAgent.indexOf('Mac OS X') != -1) {
                this.header.style.paddingTop = '3px';
                this.header.style.paddingBottom = '3px';
            }
        ...
        IntroHorse.prototype.init = function (data, checkLoop) {
            ...
            this.tween
                ...
                .set('#introLogo', {transformOrigin: "50% 50%", top: 130})
                .from('#introLogo', 0.9, {
                    scale: 0.3,
                    autoAlpha: 0,
                    force3D: true,
                ...
                .to(self.longContainer, 0.5, {clip: "rect(0px, 300px, 95px, 0px)", ease: Power0.easeNone}, '-=0.4')
                ...
                .to(self.topLine, 0.4, {clip: "rect(0px, 300px, 1px, 0px)", ease: Sine.easeOut}, '-=0.5')
                .to(self.botLine, 0.4, {clip: "rect(0px, 300px, 1px, 0px)", ease: Sine.easeOut}, '-=.4')
                ...
                .to('#header', 0.2, {clip: "rect(0px, 300px, 35px, 0px)", ease: Power0.easeNone}, '-=0.25')
            ...
            if (this.hasText) {
                this.tween
                    .to(this.topText, 0.35, {clip: " rect(0px,300px, 35px, 0px)", ease: Sine.easeOut}, '-=3.5')
                    .to(this.botText, 0.35, {clip: " rect(0px, 300px, 35px, 0px)", ease: Sine.easeOut}, '-=3.5')
            }
            ...
            if (this.hasText) {
                this.tween
                    .to(this.topText, 0.3, {clip: " rect(0px, 0px, 35px, 0px)", ease: Sine.easeOut}, '+=0.1')
                    .to(this.botText, 0.3, {clip: " rect(0px, 300px, 35px, 300px)", ease: Sine.easeOut}, '-=0.3')
            }

            if (this.isFinalScreen) {
                this.tween
                    .to('#header', 0.5, {clip: "rect(17.5px 150px 17.5px 150px)", ease: Sine.easeOut}, '-=.25')
