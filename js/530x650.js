...
app.dpi.module('logo', ['feed', 'documentLoad',
    function (feed) {
        ...
        logo.style.backgroundImage = 'url(' + app.imagesPath + feed.logo + ')';
    ...
    function (feed, terms) {
        ...
        IntroHorse.prototype.init = function (data, checkLoop) {
            ...
            this.tween
                ...
                .set('#introLogo', {transformOrigin: "50% 50%", top: 240})
                .from('#introLogo', 0.9, {
                    scale: 0.3,
                    autoAlpha: 0,
                    force3D: true,
                ...
                //.to(self.longContainer, 0.5, {clip: "rect(0px, 530px, 125px, 0px)", ease: Power0.easeNone}, '-=0.4')
                ...
                .to(self.topLine, 0.4, {clip: "rect(0px, 530px, 1px, 0px)", ease: Sine.easeOut}, '-=0.1')
                .to(self.botLine, 0.4, {clip: "rect(0px, 530px, 1px, 0px)", ease: Sine.easeOut}, '-=.4')

                .to(self.topLine, 0.25, {clip: "rect(0px, 530px, 1px, 530px)", ease: Sine.easeIn}, '+=1.5')
                .to(self.botLine, 0.25, {clip: "rect(0px, 0px, 1px, 0px)", ease: Sine.easeIn}, '-=.25')
                .to(self.boxMsg, 0.25, {autoAlpha: 0, ease: Sine.easeIn}, '-=.1')
                ...
                //    force3D: true,
                //    z: 0.1, /* add this for the jitter bug */
                //    rotationZ: "0.01deg", ease: Sine.easeOut
                //})
                .to(this.header, 0.2, {clip: "rect(0px 530px, 45px, 0px)", ease: Power0.easeNone}, '-=0.25')
                ...
                .to(self.rail, 0.5, {bottom: 60}, '-=3.3')
                .to(self.rail, 3.3, {
                    x: '-=160px', scale: 1,
                    z: 0.1, /* add this for the jitter bug */
                    rotationZ: "0.01deg", /* add this for the jitter bug */
                ...
                .to(self.leftDirt, 3.2, {y: '-=50px', x: '+=40', force3D: false, ease: SteppedEase.config(40)}, '-=3.5')
                ...
                .to(self.rail, 0.2, {autoAlpha: 0, ease: Sine.easeOut}, '-=1.3')
                .to([self.leftDirt, self.asset], 0.3, {autoAlpha: 0, ease: Sine.easeOut}, '-=0.7')
            ...
            if (this.hasText) {
                this.tween
                    .to(this.topText, 0.35, {clip: " rect(0px,530px, 70px, 0px)", ease: Sine.easeOut}, '-=3.5')
                    .to(this.botText, 0.35, {clip: " rect(0px, 530px, 90px, 0px)", ease: Sine.easeOut}, '-=3.5')
            }
            ...
            if (this.hasText) {
                this.tween
                    .to(this.topText, 0.3, {clip: " rect(0px, 0px, 70px, 0px)", ease: Sine.easeOut}, '+=0')
                    .to(this.botText, 0.3, {clip: " rect(0px, 530px, 90px, 530px)", ease: Sine.easeOut}, '-=0.3')
            }

            if (this.isFinalScreen) {
                this.tween
                    .to('#header', 0.5, {clip: "rect(22.5px 265px 22.5px 265px)", ease: Sine.easeOut}, '-=.25')
        ...
        function FinalScr(data, onComplete, isFinalScreen, checkLoop) {
            ...
            if (this.hasDay1) {
                ...
                if (navigator.userAgent.indexOf('Mac OS X') != -1) {
                    ...
                    this.textMid.style.paddingBottom = '5px';
                }
    ...
    function (feed, terms) {
        ...
        FinalScrOffer2.prototype.init = function (checkLoop) {
            ...
            this.tween
                ...
                .from(this.textBot, 0.5, {top: 500, autoAlpha: 0, ease: Elastic.easeOut.config(0.3, 0.2)}, '-=0.1')
        ...
        FinalScrOffer3.prototype.init = function (checkLoop) {
            ...
            this.tween
                ...
                .from(this.textBot, 0.5, {
                    autoAlpha: 0, top: 500, ease: Elastic.easeOut.config(0.2, 0.2),
        ...
        function playFirstScreen() {
            ...
            if (loops > feed.looping) {
                ...
                if (screens[screenIndex].hasText) {
                    screens[screenIndex].tween.restart();
                    screens[screenIndex].tween.play(2.6);
                    TweenLite.delayedCall(2.7, function () {
                        screens[screenIndex].tween.restart();
                        screens[screenIndex].tween.play(screens[screenIndex].tween.totalDuration() - 0.05);
                    ...
                    screens[screenIndex].tween.restart();
                    screens[screenIndex].tween.play(2.6);
                    TweenLite.delayedCall(2.6, function () {
                        screens[screenIndex].tween.restart();
