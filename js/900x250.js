...
            }
 ...
 if(this.hasText){
            ...
            this.tween
                .set(self.botLine,{clip: "rect(0px, 930px, 3px, 930px)"})
                ...
                .to(self.topLine, 0.4, {clip: "rect(0px, 705px, 3px, 0px)", ease: Sine.easeOut}, '-=0.1')
                .to(self.topLine, 0.4, {clip: "rect(0px, 705px, 3px, 263px)", ease: Sine.easeOut}, '-=0.2')
                .to(self.botLine, 0.4, {clip: "rect(0px, 930px, 3px, 263px)", ease: Sine.easeOut}, '-=.5')
                .to(self.botLine, 0.4, {clip: "rect(0px, 705px, 3px, 263px)", ease: Sine.easeOut}, '-=.3')

               
           
                .to(self.topLine, 0.25, {clip: "rect(0px, 930px, 3px, 263px)", ease: Sine.easeIn}, '+=1')
                .to(self.topLine, 0.25, {clip: "rect(0px, 930px, 3px, 930px)", ease: Sine.easeIn}, '-=0.2')
                .to('#introLogo', 0.25, {
                    scale: 0.1,
                    z: 0.1, /* add this for the jitter bug */
                    rotationZ: "0.01deg", /* add this for the jitter bug */
                ...
                .to(self.botLine, 0.25, {clip: "rect(0px, 0px, 3px, 0px)", ease: Sine.easeIn}, '-=.25')
                .to(self.boxMsg, 0.25, {autoAlpha: 0, ease: Sine.easeIn}, '-=.25')

                .to('#footer', 0.33, {right: 0, ease: Sine.easeOut}, '+=.2')
.to("#rail", 0.2, {
                    x: '0px',autoAlpha:1,  
                ...
                //HORSE
                .from(this.rail, 0.2, {top: 262}, '+=0.2')
                .to(self.assetContainer, 4.8, {
                    x: '+=890px',
                    force3D: false,
                    ease: SlowMo.ease.config(0.03, 0.99, false),
                    onComplete: stopShake
                }, '-=0')
                 if(this.hasText) {
                    this.tween
                      .from(this.topText, 0.4, {left: -300, ease: Sine.easeOut}, '-=3.0')

                .from(this.botText, 0.4, {left:970, ease: Sine.easeOut}, '-=3')
            }
            this.tween
                .to(self.asset, .9, {
                    scale: 1,
                ...
                .to(self.leftDirt, 4, {y: '-=50px', x: '+=60', force3D: false, ease: SteppedEase.config(40)}, '-=3.9')
                 ...
                 if(this.hasText) {
                    this.tween
                        .to(this.topText, 0.25, {autoAlpha:0 , ease: Sine.easeIn}, '-=1.4')

                        .to(this.botText, 0.25, { autoAlpha:0, ease: Sine.easeIn}, '-=1.2')
                    }
                ...
                // .to(self.assetContainer, 0.8, {
                //     x: '+=770px',
                //     force3D: false,
                //     ease: SlowMo.ease.config(0.1, 0.8, false)
                // }, '-=.0')
                .to(self.rail, 0.1,{top: 262}, '-=0.5')

                .to([self.leftDirt, self.asset,self.rightDirt ], 0.9,{left: 900,ease: Sine.easeIn},'-=0.5')
                .to([self.leftDirt, self.asset,self.rightDirt ], 0.2,{autoAlpha: 0, ease: Sine.easeOut}, '-=0.3')

                //terms CTA
                // .to('#terms', 0.25, {right: -200, ease: Sine.easeOut}, '-=0.2')
                // .to('#cta', 0.25, {right: 0, ease: Sine.easeOut},'-=0.25')
            ...
            if (this.isFinalScreen) {
                this.tween
                    .to(arrow, 0.6, {onStart: startArrow,onComplete: checkLoop}, '-=3')
            }

            if (this.isFinalScreen) {
                this.tween
                    .to('#header', 0.5, {clip: "rect(0px, 0px, 250px, 0px);", ease: Sine.easeOut}, '-=0')
                    .to('#footer', 0.5, {
                        right: '-210px', ease: Sine.easeOut
                    }, '-=.5')
            }
                ...
                // .to(this.topText, 0.25, {clip: "rect(0px, 0px, 50px, 0px)", ease: Sine.easeIn}, '+=1.8')

                // .to(this.botText, 0.25, {clip: "rect(0px, 300px, 50px, 300px)", ease: Sine.easeIn}, '-=.25')
                if (!this.isFinalScreen) {

                this.tween
                      .to('#header', 0.3, {clip: "rect(0px, 200px, 250px, 0px);", ease: Sine.easeOut}, '-=0.05')
                }
                // .to(this.topText, 0.2, {y: "+=10px", autoAlpha: 0, ease: Sine.easeOut}, '+=2')
                // .to(this.botText, 0.2, {y: "+=10px", autoAlpha: 0, ease: Sine.easeOut}, '-=0.1')
...
app.dpi.module('FinalScr', ['feed', 'terms', 'documentLoad', 'fonts',
    function (feed, terms) {
        ...
        if (navigator.userAgent.indexOf('Mac OS X') != -1) {
                       // this.textTop.style.padding = '0px 2px 1px';
                       // this.textBot.style.padding = '0px 2px 1px';
                    if (this.hasDay1) {
                       this.textMid.style.padding = '0px 0px 8px';
                   }
        }
            this.banner = document.getElementById('banner');
        ...
        FinalScrOffer2.prototype.init = function (checkLoop) {
            ...
            this.tween
               ...
               // .to('#header', 0.3, {clip: "rect(0px, 140px, 90px, 0px);", ease: Sine.easeOut})
                ...
                .from(this.textBot, 0.5, {top: 280, ease: Elastic.easeOut.config(0.3, 0.2) }, '-=0.1')
        ...
        function playFirstScreen() {
            ...
            if (loops > feed.looping) {
                ...
                if (screens[screenIndex].hasText) {
                    screens[screenIndex].tween.restart();
                    screens[screenIndex].tween.play(1.98);
                    TweenLite.delayedCall(2.8, function () {
                        screens[screenIndex].tween.restart();
                        screens[screenIndex].tween.play(screens[screenIndex].tween.totalDuration() - 0.55);
...
                    screens[screens.length - 1].tween.pause(-2.4);
