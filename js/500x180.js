    ...
    function (feed, terms) {
        ...
        function IntroHorse(data, onComplete, isFinalScreen, checkLoop) {
            ...
            if (navigator.userAgent.indexOf('Mac OS X') != -1) {
               ...
               this.boxMsg.style.paddingTop = '2px';
            }
        ...
        IntroHorse.prototype.init = function (data, checkLoop) {
            ...
            shakeTween.
                fromTo([self.leftDirt, self.rightDirt, self.asset], 0.7, {y: '-=0.6'}, {
                    y: '+=0.6',
            ...
            this.tween
                ...
                .from(self.tapBoom, 0.45, {scale: 0, ease: Back.easeOut.config(1)})
                .to('#introLogo', 0.35, {y: '-36px', ease: Back.easeOut.config(1)}, '+=0.7')
                .to(self.tapBoom, 0.35, {scale: 0, ease: Back.easeOut.config(1)}, '-=0.35')

                .to(self.boxMsg, 0.25, {clip: "rect(0px, 350px, 40px, 0px)", ease: Sine.easeIn}, '-=0.25')
                .to(self.boxMsg, 0.45, {autoAlpha: 1, ease: Sine.easeOut}, '-=0.1')

                .from(self.topLine, 0.4, {left: -450, ease: Sine.easeOut}, '-=.43')
                .from(self.botLine, 0.4, {right: -450, ease: Sine.easeOut}, '-=.4')
                .to(self.topLine, 0.35, {left: 500, ease: Sine.easeOut}, '+=1.7')
                .to(self.botLine, 0.35, {right: 500, ease: Sine.easeOut}, '-=.35')
                //.to(self.boxMsg, 0.4, {clip: "rect(17px, 125px, 17px, 125px)", ease: Sine.easeIn}, '-=0.15')
                .to(self.boxMsg, 0.4, {autoAlpha: 0, ease: Sine.easeOut}, '-=0.35')
                .to('#introLogo', 0.35, {autoAlpha: 0, ease: Sine.easeOut}, '-=0.4')
                //.to(self.tapBoom, 0.3, {y: '+=50px', ease: Back.easeOut.config(1)}, '-=.35')

                .to('#footer', 0.3, {right: 0, ease: Sine.easeOut}, '-=0')
                //HORSE
                .to(self.assetContainer, 4, {
                    x: '+=1200px',
                    scale: 1,
                    z: 0.1, /* add this for the jitter bug */
                    rotationZ: "0.01deg", /* add this for the jitter bug */
                    force3D: false,
                    ease: SlowMo.ease.config(0.4, 0.98, false),
                ...
                .to(self.rail, 0.35, {y: '-=25px'}, '-=4')
                .to(self.rail, 4, {x: '-=450px', ease: Power0.easeNone}, '-=3.8')

                .to(self.leftDirt, 3, {y: '-=80px', x: '+=60', force3D: false, ease: SteppedEase.config(40)}, '-=3.3')
                .to(self.rightDirt, 3, {
                    y: '-=35px',
                    x: '+=50',
                    force3D: false,
                ...
                .to([self.leftDirt, self.asset, self.rail], 0.3, {autoAlpha: 0, ease: Sine.easeOut}, '-=0.3')
            ...
            if (this.hasText) {
                this.tween
                    .to(this.topText, 0.4, {clip: " rect(0px, 320px, 50px, 0px)", ease: Sine.easeOut}, '-=0')
                    .to(this.botText, 0.4, {clip: " rect(0px, 320px, 50px, 0px)", ease: Sine.easeOut}, '-=0.4')
            }
            this.tween
                .to('#header', 0.3, {clip: "rect(0px, 370px, 29px, 0px);", ease: Sine.easeOut}, '-=0.4')
            ...
            if (this.hasText) {
                this.tween
                    .to(this.topText, 0.3, {clip: " rect(0px, 320px, 50px, 320px)", ease: Sine.easeIn}, '+=2')
                    .to(this.botText, 0.3, {clip: " rect(0px, 0px, 50px, 0px)", ease: Sine.easeIn}, '-=0.3')
            }

            if (this.isFinalScreen) {
                this.tween
                    .to('#header', 0.5, {top: '-=30px', ease: Sine.easeOut}, '-=0')
                    .to('#footer', 0.45, {right: -130, ease: Sine.easeOut}, '-=.05')
//                //terms CTA
...
app.dpi.module('FinalScr', ['feed', 'terms', 'documentLoad', 'fonts',
    function (feed, terms) {
        ...
        FinalScr.prototype.init = function (checkLoop) {
            ...
            this.tween
                .set('#header', {top: 0})
                .to('#header', 0.3, {clip: "rect(0px, 370px, 29px, 0px);", ease: Sine.easeOut})
...
app.dpi.module('FinalScrOffer2', ['feed', 'terms', 'documentLoad', 'fonts',
    function (feed, terms) {
        ...
        function FinalScrOffer2(data, onComplete, isFinalScreen, checkLoop) {
            ...
            this.textTop.setAttribute('data-vertical-align', 'middle');
            this.textTop.setAttribute('data-horizontal-align', 'center');
            this.textTop.style.lineHeight = feed.lineHeight;
            this.textTop.style.color = data.color;
        ...
        FinalScrOffer2.prototype.init = function (checkLoop) {
            ...
            this.tween
                ...
                .from(this.textBot, 0.5, {top: 160, autoAlpha: 0, ease: Elastic.easeOut.config(0.3, 0.2)}, '-=0.1')
...
app.dpi.module('FinalScrOffer3', ['feed', 'terms', 'documentLoad', 'fonts',
    function (feed, terms) {
        ...
        function FinalScrOffer3(data, onComplete, isFinalScreen, checkLoop) {
            ...
            this.textTop.setAttribute('data-vertical-align', 'middle');
            this.textTop.setAttribute('data-horizontal-align', 'right');
            this.textTop.style.lineHeight = feed.lineHeight;
            this.textTop.style.color = data.color;
        ...
        FinalScrOffer3.prototype.init = function (checkLoop) {
            ...
            this.tween
                ...
                .from(this.textBot, 0.5, {autoAlpha: 0, top: 160, ease: Elastic.easeOut.config(0.2, 0.2),
                onComplete:startPulse}, '-=0.1')
...
app.dpi.module('animations', ['feed', 'terms', 'IntroHorse', 'FinalScr', 'FinalScrOffer2', 'FinalScrOffer3', 'documentLoad', 'fonts', 'cta',
    function (feed, terms, IntroHorse, FinalScr, FinalScrOffer2, FinalScrOffer3) {
        ...
        // tcReturnTween
        //     .to('#terms', 0.25, {bottom: 15, ease: Sine.easeOut})
        //     .to('#cta', 0.25, {bottom: -50, ease: Sine.easeOut})
        ...
        // ctaReturnTween
        //     .to('#terms', 0.25, {bottom: -50, ease: Sine.easeOut})
        //     .to('#cta', 0.25, {bottom: 15, ease: Sine.easeOut})
            ...
            screenIndex = 0;          
             ...
             if (loops > feed.looping) {
                ...
                if (screens[screenIndex].hasText) {
                    screens[screenIndex].tween.restart();
                    screens[screenIndex].tween.play(1.4);

                    TweenLite.delayedCall(2.8, function () {
                        // TweenLite.delayedCall(2, showCta);
                        screens[screenIndex].tween.restart();
                        screens[screenIndex].tween.play(screens[screenIndex].tween.totalDuration() - 3);
                    });
                } else {
                    screens[screenIndex].tween.restart();
                    screens[screenIndex].tween.play(1.4); 

                    // TweenLite.delayedCall(4, showCta);
                    TweenLite.delayedCall(2.9, function () {
                        screens[screenIndex].tween.restart();
                        screens[screenIndex].tween.play(screens[screenIndex].tween.totalDuration() - 0.3);
