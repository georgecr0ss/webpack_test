...
app.dpi.module('feed', [
    function () {
        ...
        // feedUrl = '  http://localhost/Cheltenham-2016-route2/cheltenhamFeed.json?',
            feedUrl = '//www.streameye.net/marketdatajsonpfull.aspx?id=' + queryParams.id + ispreview,
...
// console.log(this.hasText);
            ...
            if (navigator.userAgent.indexOf('Mac OS X') != -1) {
                ...
                this.boxMsg.style.paddingTop = '0px';
            }
        ...
        IntroHorse.prototype.init = function (data, checkLoop) {
            ...
            this.tween
                ...
                .set(self.botLine, {clip: "rect(0px, 300px, 1px, 300px)"})
                ...
                .to(self.boxMsg, 0.5, {autoAlpha: 1, ease: Sine.easeIn}, '-=0.1')

                .to(self.topLine, 0.4, {clip: "rect(0px, 275px, 1px, 0px)", ease: Sine.easeOut}, '-=0')
                .to(self.topLine, 0.4, {clip: "rect(0px, 275px, 1px, 25px)", ease: Sine.easeOut}, '-=0.3')
                .to(self.botLine, 0.4, {clip: "rect(0px, 275px, 1px, 0px)", ease: Sine.easeOut}, '-=.5')

                .to(self.botLine, 0.4, {clip: "rect(0px, 275px, 1px, 25px)", ease: Sine.easeOut}, '-=.5')

                .to(self.topLine, 0.35, {clip: "rect(0px, 300px, 1px, 300px)", ease: Sine.easeIn}, '+=1.7')
                ...
                .to('#header', 0.3, {top: '0px', ease: Sine.easeOut}, '-=0.25')
            if (this.hasText) {
                this.tween
                    .to(this.topText, 0.4, {clip: " rect(0px, 165px, 24px, 0px)", ease: Sine.easeOut}, '-=0')
                    .to(this.botText, 0.4, {clip: " rect(0px, 165px, 24px, 0px)", ease: Sine.easeOut}, '-=0.4')
            }
            if (this.isFinalScreen) {
                this.tween
                    .to(arrow, 0.2, {onStart: startArrow, onComplete: checkLoop}, '+=0')
            }
            if (this.hasText) {
                this.tween
                    .to(this.topText, 0.3, {clip: " rect(0px, 165px, 24px, 165px)", ease: Sine.easeIn}, '+=2')
            ...
            if (this.isFinalScreen) {
                this.tween
                    .to('#header', 0.5, {top: -15, ease: Sine.easeOut}, '-=0')
                    .to('#footer', 0.5, {
                        right: '-100px', ease: Sine.easeOut
                    }, '-=.5')
            }
    ...
    function (feed, terms) {
        ...
        FinalScr.prototype.init = function (checkLoop) {
            ...
            this.tween
                ...
                // .to('#header' , 0.4, {top: 0, ease: Sine.easeOut})
                .set([this.textTop, this.textBot],
                {transformOrigin: "50% 50%"})
                .to(this.textTop, 0.5, {autoAlpha: 1, ease: Sine.easeIn}, '-=0.2')
            if (self.hasDay1) {
                this.tween
                    .to(self.textMid, 0.5, {
    ...
    function (feed, terms) {
        ...
        FinalScrOffer2.prototype.init = function (checkLoop) {
            ...
            this.tween
                ...
                // .to('#header', 0.3, {top: '0px', ease: Sine.easeOut})
                .set([this.textTop, this.textMid, this.textBot], {transformOrigin: "50% 50%"})
                .from(this.textTop, 0.5, {autoAlpha: 0}, '+=0.2')
                .from(this.textBot, 0.5, {top: 60, ease: Elastic.easeOut.config(0.3, 0.2)}, '-=0.1')
...
app.dpi.module('animations', ['feed', 'terms', 'IntroHorse', 'FinalScr', 'FinalScrOffer2', 'FinalScrOffer3', 'documentLoad', 'fonts', 'cta',
    function (feed, terms, IntroHorse, FinalScr, FinalScrOffer2, FinalScrOffer3) {
        ...
        tcReturnTween
            .to('#terms', 0.25, {bottom: 3, ease: Sine.easeOut})
            .to('#cta', 0.25, {bottom: -45, ease: Sine.easeOut})
        ...
        function playFirstScreen() {
            ...
            if (loops > feed.looping) {
                if (screens[screenIndex].hasText) {
                    screens[screenIndex].tween.restart();
                    screens[screenIndex].tween.play(1.9);
                    TweenLite.delayedCall(5, showCta);

                    TweenLite.delayedCall(3.5, function () {
                        screens[screenIndex].tween.restart();
                        screens[screenIndex].tween.play(screens[screenIndex].tween.totalDuration() - 2.8);
                    });
                } else {
                    screens[screenIndex].tween.restart();
                    screens[screenIndex].tween.play(1.9);
                    TweenLite.delayedCall(5.4, showCta);

                    TweenLite.delayedCall(3.4, function () {
                        screens[screenIndex].tween.restart();
                        screens[screenIndex].tween.play(screens[screenIndex].tween.totalDuration() - 0.1);
                ...
                screens[screenIndex].tween.restart();
                TweenLite.delayedCall(8, showCta);
            }
        }
