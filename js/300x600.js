    ...
    function (feed, terms) {
        ...
        IntroHorse.prototype.init = function (data, checkLoop) {
            ...
            this.tween
                ...
                .to('#introLogo', 0.5, {y: '-=95px', ease: Sine.easeIn}, '+=0.5')
                ...
                .to('#introLogo', 0.5, {y: '-=155px', ease: Sine.easeOut})
            ...
            if (this.hasText) {
                this.tween
                    .to(this.topText, 0.35, {clip: " rect(0px,300px, 70px, 0px)", ease: Sine.easeOut}, '-=3.5')
                    .to(this.botText, 0.35, {clip: " rect(0px, 300px, 70px, 0px)", ease: Sine.easeOut}, '-=3.5')
            }
            ...
            if (this.hasText) {
                this.tween
                    .to(this.topText, 0.3, {clip: " rect(0px, 0px, 70px, 0px)", ease: Sine.easeOut}, '+=0.1')
                    .to(this.botText, 0.3, {clip: " rect(0px, 300px, 70px, 300px)", ease: Sine.easeOut}, '-=0.3')
            }

            if (this.isFinalScreen) {
                this.tween
                    .to('#header', 0.5, {clip: "rect(16.5px 150px 16.5px 150px)", ease: Sine.easeOut}, '-=.25')
    ...
    function (feed, terms, IntroHorse, FinalScr, FinalScrOffer2, FinalScrOffer3) {
        ...
        function playFirstScreen() {
            ...
            if (loops > feed.looping) {
                ...
                screens[screenIndex].tween.restart();
                screens[screenIndex].tween.play(2.15);
