...
app.dpi.module('fonts', ['feed', 'documentLoad',
    function(feed) {
        var that = this,
            css = {
...
app.dpi.module('IntroHorse', ['feed', 'terms', 'documentLoad', 'fonts',
    function(feed, terms) {
        ...
        IntroHorse.prototype.init = function(data, checkLoop) {
            ...
            this.tween
                .set(self.botLine, {
                    clip: "rect(0px, 930px, 3px, 930px)"
                })
                .set(self.topLine, {
                    clip: "rect(0px, 0px, 3px, 0px)"
                })
                .set([self.leftDirt, self.asset], {
                    autoAlpha: 1
                })
                .set('#introLogo', {
            ...
            .to(self.topLine, 0.4, {
                clip: "rect(0px, 705px, 3px, 0px)",
                ease: Sine.easeOut
            }, '-=0.1')
                .to(self.topLine, 0.4, {
                    clip: "rect(0px, 705px, 3px, 263px)",
                    ease: Sine.easeOut
                }, '-=0.2')
                .to(self.botLine, 0.4, {
                    clip: "rect(0px, 930px, 3px, 263px)",
                    ease: Sine.easeOut
                }, '-=.5')
                .to(self.botLine, 0.4, {
                    clip: "rect(0px, 705px, 3px, 263px)",
            ...
            if (this.hasText) {
                this.tween
                    .from(this.topText, 0.4, {
                        left: -300,
                        ease: Sine.easeOut
                    }, '-=3.0')

                .from(this.botText, 0.4, {
                    left: 970,
                    ease: Sine.easeOut
                }, '-=3')
            }
            ...
            if (this.hasText) {
                this.tween
                    .to(this.topText, 0.25, {
                        autoAlpha: 0,
                        ease: Sine.easeIn
                    }, '-=1.4')

                .to(this.botText, 0.25, {
                    autoAlpha: 0,
                    ease: Sine.easeIn
                }, '-=1.2')
            }
            ...
            .to([self.leftDirt, self.asset, self.rightDirt], 0.9, {
                left: 900,
                ease: Sine.easeIn
            }, '-=0.5')
                .to([self.leftDirt, self.asset, self.rightDirt], 0.2, {
                    autoAlpha: 0,
                    ease: Sine.easeOut
                }, '-=0.3')
...
app.dpi.module('FinalScrOffer2', ['feed', 'terms', 'documentLoad', 'fonts',
    function(feed, terms) {
        ...
        FinalScrOffer2.prototype.init = function(checkLoop) {
            ...
            .set([this.textTop, this.textMid, this.textBot], {
                transformOrigin: "50% 50%"
            })
                .from(this.textTop, 0.5, {
                    autoAlpha: 0
                }, '+=0.2')
