...
            }
 ...
 if(this.hasText){
            ...
            this.tween
                ...
                .to(self.topLine, 0.4, {clip: "rect(0px, 683px, 3px, 0px)", ease: Sine.easeOut}, '-=0.1')
                .to(self.topLine, 0.4, {clip: "rect(0px, 683px, 3px, 243px)", ease: Sine.easeOut}, '-=0.2')
                .to(self.botLine, 0.4, {clip: "rect(0px, 930px, 3px, 243px)", ease: Sine.easeOut}, '-=.5')
                .to(self.botLine, 0.4, {clip: "rect(0px, 683px, 3px, 243px)", ease: Sine.easeOut}, '-=.3')

               
           
                .to(self.topLine, 0.25, {clip: "rect(0px, 930px, 3px, 243px)", ease: Sine.easeIn}, '+=1')
                ...
                .to('#footer', 0.3, {right: 0, ease: Sine.easeOut}, '+=.1')
.to("#rail", 0.2, {
                    x: '0px',autoAlpha:1,  
                ...
                //HORSE
                .from(this.rail, 0.3, {top: 202})
                .to(self.assetContainer, 4.8, {
                    x: '+=930px',
                    force3D: false,
                    ease: SlowMo.ease.config(0.01, 0.99, false),
            ...
            this.tween
                ...
                // }, '-=.0')
                this.tween
                .to(self.rail, 0.1,{top: 202}, '-=0.5')

                .to([self.leftDirt, self.asset,self.rightDirt ], 1,{left: 930,ease: Sine.easeIn},'-=0.5')
            ...
            if (!this.isFinalScreen) {
                ...
                this.tween
                   .to('#header', 0.3, {clip: "rect(0px, 160px, 180px, 0px);", ease: Sine.easeOut}, '-=0.15')
             }
...
app.dpi.module('FinalScr', ['feed', 'terms', 'documentLoad', 'fonts',
    function (feed, terms) {
        ...
        if (navigator.userAgent.indexOf('Mac OS X') != -1) {
                    ...
                    if (this.hasDay1) {
                       this.textMid.style.padding = '0px 0px 14px';
                   }
        }
            this.banner = document.getElementById('banner');
      ...
      //this.banner.appendChild(this.logoFin);    
        ...
        FinalScr.prototype.init = function (checkLoop) {
            ...
            if (this.isFinalScreen) {
                this.tween
                    .to('#header', 0.5, {clip: "rect(0px, 0px, 180px, 0px);", ease: Sine.easeOut}, '-=0')
                    .to('#footer', 0.5, {
                        right: '-180px', ease: Sine.easeOut
                    }, '-=.5')
            }
        ...
        FinalScrOffer2.prototype.init = function (checkLoop) {
            ...
            this.tween
               ...
               // .to('#header', 0.3, {clip: "rect(0px, 140px, 90px, 0px);", ease: Sine.easeOut})
                ...
                .from(this.textBot, 0.5, {top: 200, ease: Elastic.easeOut.config(0.3, 0.2) }, '-=0.1')
        ...
        function playFirstScreen() {
            ...
            if (loops > feed.looping) {
                ...
                if (screens[screenIndex].hasText) {
                    screens[screenIndex].tween.restart();
                    screens[screenIndex].tween.play(1.8);
