...
            }
 ...
 if(this.hasText){
            ...
            this.tween
                ...
                .to('#footer', 0.3, {right: 0, ease: Sine.easeOut}, '+=.2')
.to("#rail", 0.2, {
                    x: '0px',autoAlpha:1,  
                ...
                //HORSE
                .from(this.rail, 0.2, {top: 232})
                .to(self.assetContainer, 4.8, {
                    x: '+=1200px',
                    force3D: false,
                    ease: SlowMo.ease.config(0.001, 0.99, false),
            ...
            this.tween
                ...
                .to([self.leftDirt, self.asset,self.rightDirt ], 0.3,{left: 970,ease: Sine.easeIn},'-=0.5')
...
app.dpi.module('FinalScr', ['feed', 'terms', 'documentLoad', 'fonts',
    function (feed, terms) {
        ...
        if (navigator.userAgent.indexOf('Mac OS X') != -1) {
                    ...
                    if (this.hasDay1) {
                       this.textMid.style.padding = '0px 2px 8px';
                   }
        }
