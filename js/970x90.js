...
            }
        ...
        IntroHorse.prototype.init = function (data, checkLoop) {
            ...
            this.tween
                .set(self.botLine,{clip: "rect(0px, 970px, 3px, 970px)"})
                ...
                .to(self.topLine, 0.4, {clip: "rect(0px, 713px, 3px, 0px)", ease: Sine.easeOut}, '-=0.1')
                .to(self.topLine, 0.4, {clip: "rect(0px, 713px, 3px, 253px)", ease: Sine.easeOut}, '-=0.2')
                .to(self.botLine, 0.4, {clip: "rect(0px, 970px, 3px, 253px)", ease: Sine.easeOut}, '-=.5')
                .to(self.botLine, 0.4, {clip: "rect(0px, 713px, 3px, 253px)", ease: Sine.easeOut}, '-=.3')

               
           
                .to(self.topLine, 0.25, {clip: "rect(0px, 970px, 3px, 253px)", ease: Sine.easeIn}, '+=1')
                .to(self.topLine, 0.25, {clip: "rect(0px, 970px, 3px, 970px)", ease: Sine.easeIn}, '-=0.2')
                .to('#introLogo', 0.25, {
                    scale: 0.1,
                    z: 0.1, /* add this for the jitter bug */
                    rotationZ: "0.01deg", /* add this for the jitter bug */
...
.to("#rail", 0.2, {
                ...
                .to(self.assetContainer, 4.8, {
                    x: '+=1050px',
                    force3D: false,
                    ease: SlowMo.ease.config(0.1, 0.97, false),
                ...
                // }, '-=.0')
                    this.tween
                .to(self.rail, 0.1,{top: 102}, '-=0.5')
                
                .to([self.leftDirt, self.asset,self.rightDirt ], 1,{left: 970,ease: Sine.easeIn},'-=0.5')
               ...
               if (!this.isFinalScreen) {
                this.tween
                      .to('#header', 0.3, {clip: "rect(0px, 160px, 90px, 0px);", ease: Sine.easeOut}, '-=0.05')
              }
