...
app.dpi.module('IntroHorse', ['feed', 'terms', 'documentLoad', 'fonts',
    function (feed, terms) {
        ...
        IntroHorse.prototype.init = function (data, checkLoop) {
            ...
            this.tween
                .set(self.botLine, {clip: "rect(0px, 468px, 3px, 468px)"})
                ...
                .to(self.topLine, 0.3, {clip: "rect(0px, 365px, 3px, 0px)", ease: Sine.easeOut}, '-=0')
                .to(self.topLine, 0.3, {clip: "rect(0px, 365px, 3px, 103px)", ease: Sine.easeOut}, '-=0.1')
                .to(self.botLine, 0.3, {clip: "rect(0px, 465px, 3px, 103px)", ease: Sine.easeOut}, '-=.4')
                .to(self.botLine, 0.3, {clip: "rect(0px, 368px, 3px, 103px)", ease: Sine.easeOut}, '-=.2')

                .to(self.topLine, 0.2, {clip: "rect(0px, 468px, 3px, 468px)", ease: Sine.easeIn}, '+=1')
                ...
                .to("#rail", 2.9, {x: '-60x', ease: Power0.easeNone}, '-=2.9')
                .to(self.asset, 0.7, {
                    scale: 1,
                ...
                .to(self.leftDirt, 3.6, {y: '-=25px', x: '+=80', force3D: false, ease: SteppedEase.config(40)}, '-=3.5')
            ...
            if (this.hasText) {
                this.tween
                    .to(this.topText, 0.4, {clip: "rect(0px, 300px, 50px, 0px)", ease: Sine.easeOut}, '-=0')

                    .to(this.botText, 0.4, {clip: "rect(0px, 300px, 50px, 0px)", ease: Sine.easeOut}, '-=0.5')
            }
            ...
            if (this.hasText) {
                this.tween
                    .to(this.topText, 0.25, {clip: "rect(0px, 0px, 33px, 0px)", ease: Sine.easeIn}, '+=1.8')
                    .to(this.botText, 0.25, {clip: "rect(0px, 300px, 33px, 300px)", ease: Sine.easeIn}, '-=.25')
            }

            if (this.isFinalScreen) {
                this.tween
                    .to('#footer', 0.5, {
                        right: '-130px', ease: Sine.easeOut
                    }, '-=0')
            }
            if (!this.isFinalScreen) {
                this.tween
                    .to('#header', 0.3, {clip: "rect(0px, 90px, 90px, 0px)", ease: Sine.easeOut}, '-=0')
            }
    ...
    function (feed, terms) {
        ...
        FinalScrOffer2.prototype.init = function (checkLoop) {
            ...
            this.tween
                ...
                .from(this.textBot, 0.5, {top: 100, ease: Elastic.easeOut.config(0.3, 0.2)}, '-=0.1')
        ...
        function playFirstScreen() {
            ...
            if (loops > feed.looping) {
                if (screens[screenIndex].hasText) {
                    ...
                    TweenLite.delayedCall(5.3, showCta);

                    TweenLite.delayedCall(2.8, function () {
                        screens[screenIndex].tween.restart();
                        screens[screenIndex].tween.play(screens[screenIndex].tween.totalDuration() - 2.7);
                    });
                } else {
                    screens[screenIndex].tween.restart();
                    screens[screenIndex].tween.play(2.5);
                ...
                screens[screenIndex].tween.restart();
                TweenLite.delayedCall(9, showCta);
            }
        }
