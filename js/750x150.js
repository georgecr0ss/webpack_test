...
.to("#rail", 0.2, {
                ...
                .from(this.botText, 0.4, {left: 758, ease: Sine.easeOut}, '-=3')
            }
              this.tween
                .to(self.asset, .9, {
                    scale: 1.1,
                ...
                // }, '-=.0')
this.tween
                .to(self.rail, 0.1,{top: 202}, '-=0.2')

                .to([self.leftDirt, self.asset,self.rightDirt ], 1,{left: 750,ease: Sine.easeIn},'-=0.5')
               ...
               if (!this.isFinalScreen) {
                ...
                this.tween
                       .to('#header', 0.3, {clip: "rect(0px, 140px, 150px, 0px);", ease: Sine.easeOut}, '-=0.05')
                }
    ...
    function (feed, terms) {
      ...
      //this.banner.appendChild(this.logoFin);    
        ...
        FinalScr.prototype.init = function (checkLoop) {
            ...
            if (this.isFinalScreen) {
                this.tween
                    .to('#header', 0.5, {clip: "rect(0px, 0px, 150px, 0px);", ease: Sine.easeOut}, '-=0')
                    .to('#footer', 0.5, {
        ...
        FinalScrOffer2.prototype.init = function (checkLoop) {
            ...
            this.tween
               ...
               // .to('#header', 0.3, {clip: "rect(0px, 140px, 90px, 0px);", ease: Sine.easeOut})
                ...
                .from(this.textBot, 0.5, {top: 160, ease: Elastic.easeOut.config(0.3, 0.2) }, '-=0.1')
