...
// console.log(this.hasText);
        ...
        IntroHorse.prototype.init = function (data, checkLoop) {
            ...
            this.tween
                .set(self.botLine,{clip: "rect(0px, 480px, 1px, 480px)" } )
                ...
                .from('#footer', 0.4, {bottom: -55, ease: Sine.easeOut}, '-=.4')
                //.to(self.tapBoom, 0.4, {y: '-=45px', ease: Sine.easeOut}, '-=0.4')

                .to(self.topLine, 0.4, {clip: "rect(0px, 425px, 1px, 0px)", ease: Sine.easeOut}, '-=0')
                .to(self.topLine, 0.4, {clip: "rect(0px, 425px, 1px, 65px)", ease: Sine.easeOut}, '-=0.2')

                .to(self.botLine, 0.4, {clip:"rect(0px, 425px, 1px, 0px)", ease: Sine.easeOut}, '-=.5')
                .to(self.botLine, 0.4, {clip: "rect(0px, 425px, 1px, 65px)", ease: Sine.easeOut}, '-=.5')

                .to(self.topLine, 0.25, {clip: "rect(0px, 480px, 1px, 480px)", ease: Sine.easeIn}, '+=1')
            ...
            if (this.hasText) {
                this.tween
                    .to(this.topText, 0.35, {clip: " rect(0px, 350px, 60px, 0px)", ease: Sine.easeOut}, '-=0')
                    .to(this.botText, 0.35, {clip: " rect(0px, 350px, 60px, 0px)", ease: Sine.easeOut}, '-=0.35')
            }
            ...
            if (this.hasText) {
                this.tween
                    .to(this.topText, 0.3, {clip: " rect(0px, 0px, 60px, 0px)", ease: Sine.easeOut}, '+=2')
                    .to(this.botText, 0.3, {clip: " rect(0px, 350px, 60px, 350px)", ease: Sine.easeOut}, '-=0.3')
            }
            if (this.isFinalScreen) {
                this.tween
                    .to('#header', 0.5, {top: '-50px', ease: Sine.easeOut}, '-=0')
                    .to('#footer', 0.5, {
            ...
            if (loops > feed.looping) {
                ...
                if (screens[screenIndex].hasText) {
                    ...
                    TweenLite.delayedCall(3, function () {
                        screens[screenIndex].tween.restart();
                        screens[screenIndex].tween.play(screens[screenIndex].tween.totalDuration() - 2.5);
                    ...
                    screens[screenIndex].tween.restart();
                    screens[screenIndex].tween.play(2.5);
                    TweenLite.delayedCall(4.2, showCta);
                    TweenLite.delayedCall(3, function () {
                        screens[screenIndex].tween.restart();
                        screens[screenIndex].tween.play(screens[screenIndex].tween.totalDuration() - 0.0);
