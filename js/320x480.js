...
app.dpi.module('IntroHorse', ['feed', 'terms', 'documentLoad', 'fonts',
    function (feed, terms) {
        ...
        function IntroHorse(data, onComplete, isFinalScreen, checkLoop) {
            ...
            this.hasText = ((data.txt1 !== '' && typeof txt1 !== 'undefined' && txt1 !== null) ||
        ...
        IntroHorse.prototype.init = function (data, checkLoop) {
            ...
            this.tween
                ...
                .set('#introLogo', {transformOrigin: "50% 50%", top: 180})
                .from('#introLogo', 0.9, {
                    scale: 0.3,
                    autoAlpha: 0,
                    force3D: true,
                ...
                .to('#introLogo', 0.5, {y: '-=95px', ease: Sine.easeIn}, '+=0.7')


                .to(self.longContainer, 0.5, {clip: "rect(0px, 320px, 95px, 0px)", ease: Power0.easeNone}, '-=0.4')
                ...
                .to(self.topLine, 0.4, {clip: "rect(0px, 320px, 1px, 0px)", ease: Sine.easeOut}, '-=0.5')
                .to(self.botLine, 0.4, {clip: "rect(0px, 320px, 1px, 0px)", ease: Sine.easeOut}, '-=.4')

                .to(self.topLine, 0.25, {clip: "rect(0px, 320px, 1px, 320px)", ease: Sine.easeIn}, '+=1.5')
                ...
                .to('#header', 0.2, {clip: "rect(0px, 320px, 35px, 0px)", ease: Power0.easeNone}, '-=0.25')
                ...
                .to(self.rail, 0.5, {bottom: 50}, '-=3.3')
                .to(self.rail, 3, {
                    x: '-=100px', scale: 1,
                    z: 0.1, /* add this for the jitter bug */
                    rotationZ: "0.01deg", /* add this for the jitter bug */
                ...
                .to(self.leftDirt, 3.2, {y: '-=40px', x: '+=20', force3D: false, ease: SteppedEase.config(40)}, '-=3.5')
                ...
                .to(self.rail, 0.2, {autoAlpha: 0, ease: Sine.easeOut}, '-=0.9')
            ...
            if (this.hasText) {
                this.tween
                    .to(this.topText, 0.35, {clip: " rect(0px,320px, 50px, 0px)", ease: Sine.easeOut}, '-=3.5')
                    .to(this.botText, 0.35, {clip: " rect(0px, 320px, 50px, 0px)", ease: Sine.easeOut}, '-=3.5')
            }
            ...
            if (this.hasText) {
                this.tween
                    .to(this.topText, 0.3, {clip: " rect(0px, 0px, 50px, 0px)", ease: Sine.easeOut}, '+=0.1')
                    .to(this.botText, 0.3, {clip: " rect(0px, 320px, 50px, 320px)", ease: Sine.easeOut}, '-=0.3')
            }

            if (this.isFinalScreen) {
                this.tween
                    .to('#header', 0.5, {clip: "rect(17.5px 160px 17.5px 160px)", ease: Sine.easeOut}, '-=.25')
    ...
    function (feed, terms) {
        ...
        FinalScrOffer2.prototype.init = function (checkLoop) {
            ...
            this.tween
                ...
                .from(this.textBot, 0.5, {top: 570, autoAlpha: 0, ease: Elastic.easeOut.config(0.3, 0.2)}, '-=0.1')
    ...
    function (feed, terms, IntroHorse, FinalScr, FinalScrOffer2, FinalScrOffer3) {
        ...
        function playFirstScreen() {
            ...
            if (loops > feed.looping) {
                ...
                screens[screenIndex].tween.restart();
                screens[screenIndex].tween.play(2.35);
