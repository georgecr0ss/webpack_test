...
app.dpi.module('feed', [
    function () {
        ...
        // feedUrl = '  http://localhost/Cheltenham-2016-route2/cheltenhamFeed.json?',
            feedUrl = '//www.streameye.net/marketdatajsonpfull.aspx?id=' + queryParams.id + ispreview,
        feedUrl = 'http://localhost/fontCorrection_BritishOpen/src/wimbledonImgTem.json?',
...
            
        ...
        IntroHorse.prototype.init = function (data, checkLoop) {
            ...
            this.tween
                ...
                .set(self.botLine, {clip: "rect(0px, 320px, 1px, 320px)"})
                ...
                .to(self.boxMsg, 0.25, {autoAlpha: 1, ease: Sine.easeIn}, '-=0.1')
                //.to(self.boxMsg, 0.45, {autoAlpha: 1, ease: Sine.easeOut}, '-=0.1')

                .to(self.topLine, 0.4, {clip: "rect(0px, 295px, 1px, 0px)", ease: Sine.easeOut}, '-=0')
                .to(self.topLine, 0.4, {clip: "rect(0px, 295px, 1px, 25px)", ease: Sine.easeOut}, '-=0.3')
                .to(self.botLine, 0.4, {clip: "rect(0px, 295px, 1px, 0px)", ease: Sine.easeOut}, '-=.5')

                .to(self.botLine, 0.4, {clip: "rect(0px, 295px, 1px, 25px)", ease: Sine.easeOut}, '-=.5')

                .to(self.topLine, 0.35, {clip: "rect(0px, 320px, 1px, 320px)", ease: Sine.easeIn}, '+=1.7')
        ...
        function playFirstScreen() {
            ...
            if (loops > feed.looping) {
                if (screens[screenIndex].hasText) {
                    ...
                    TweenLite.delayedCall(3.2, function () {
                        screens[screenIndex].tween.restart();
