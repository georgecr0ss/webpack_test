...
            }
        ...
        IntroHorse.prototype.init = function (data, checkLoop) {
            ...
            this.tween
                .set(self.botLine,{clip: "rect(0px, 728px, 3px, 728px)"})
                ...
                .to(self.topLine, 0.4, {clip: "rect(0px, 567px, 3px, 0px)", ease: Sine.easeOut}, '-=0.1')
                .to(self.topLine, 0.4, {clip: "rect(0px, 567px, 3px, 163px)", ease: Sine.easeOut}, '-=0.2')
                .to(self.botLine, 0.4, {clip: "rect(0px, 728px, 3px, 163px)", ease: Sine.easeOut}, '-=.5')
                .to(self.botLine, 0.4, {clip: "rect(0px, 567px, 3px, 163px)", ease: Sine.easeOut}, '-=.3')

               
           
                .to(self.topLine, 0.25, {clip: "rect(0px, 728px, 3px, 210px)", ease: Sine.easeIn}, '+=1')
                .to(self.topLine, 0.25, {clip: "rect(0px, 728px, 3px, 728px)", ease: Sine.easeIn}, '-=0.2')
                .to('#introLogo', 0.25, {
                    scale: 0.1,
                    z: 0.1, /* add this for the jitter bug */
                    rotationZ: "0.01deg", /* add this for the jitter bug */
...
.to("#rail", 0.2, {
                ...
                .to(self.assetContainer, 4.8, {
                    x: '+=850px',
                    force3D: false,
                    ease: SlowMo.ease.config(0.01, 0.97, false),
                ...
                .from(this.botText, 0.4, {left: 728, ease: Sine.easeOut}, '-=3')
            }
              this.tween
                .to(self.asset, .9, {
                    scale: 1,
                ...
                .to(self.leftDirt, 4, {y: '-=30px', x: '+=60', force3D: false, ease: SteppedEase.config(40)}, '-=3.9')
                ...
                // }, '-=.0')
this.tween
                .to(self.rail, 0.1,{top: 102}, '-=0.2')

                .to([self.leftDirt, self.asset,self.rightDirt ], 1,{left: 730,ease: Sine.easeIn},'-=0.5')
               ...
               if (!this.isFinalScreen) {
                ...
                this.tween
                       .to('#header', 0.3, {clip: "rect(0px, 140px, 90px, 0px);", ease: Sine.easeOut}, '-=0.05')
                }
        ...
        FinalScrOffer2.prototype.init = function (checkLoop) {
            ...
            this.tween
               ...
               // .to('#header', 0.3, {clip: "rect(0px, 140px, 90px, 0px);", ease: Sine.easeOut})
                ...
                .from(this.textBot, 0.5, {top: 90, ease: Elastic.easeOut.config(0.3, 0.2) }, '-=0.1')
        ...
        function playFirstScreen() {
            ...
            if (loops > feed.looping) {
                ...
                if (screens[screenIndex].hasText) {
                    screens[screenIndex].tween.restart();
                    screens[screenIndex].tween.play(2.2);
                    TweenLite.delayedCall(4.5, showCta);
                    TweenLite.delayedCall(2.8, function () {
                        screens[screenIndex].tween.restart();
                        screens[screenIndex].tween.play(screens[screenIndex].tween.totalDuration() - 0.25);
